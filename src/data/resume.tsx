...
export const DATA = {
  ...
  description: '웹 개발하는 소프트웨어 엔지니어 은호입니다 🥰',
  summary:
  ...
  projects: [
    {
      ...
      links: [
        ...
        {
          type: 'Source',
          href: 'https://github.com/Valentin1495/Gemini',
    ...
    // },
    {
      ...
      links: [
        ...
        {
          type: 'Source',
          href: 'https://github.com/Valentin1495/PostPlanet',
          icon: <Icons.github className='size-3' />,
        },
      ],
      image: '',
    ...
    },
    {
      ...
      links: [
        ...
        {
          type: 'Source',
          href: 'https://github.com/Valentin1495/WhisperWave',
          icon: <Icons.github className='size-3' />,
        },
      ],
      image: '',
